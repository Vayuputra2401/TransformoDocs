...
class LLMDocumentProcessor:
    def __init__(self):
        ...
        self.extraction_pipeline = pipeline("text-generation", model="numind/NuExtract", trust_remote_code=True)
